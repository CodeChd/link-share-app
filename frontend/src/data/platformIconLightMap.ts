...
export const platformIconLightMap: IconMap = {
  ...
  "Frontend Mentor": "/images/icon-frontend-mentor-light.svg",
  Twitter: "/images/icon-twitter-light.svg",
  LinkedIn: "/images/icon-linkedin-light.svg",
  ...
  GitLab: "#/images/icon-gitlab-light.svg",
  Hashnode: "/images/icon-hashnode-light.svg",
  "Stack Overflow": "/images/icon-stack-overflow-light.svg",
};
