  ...
  return (
    <header className="p-5">
      ...
      >
        ...
        <nav className="flex gap-4 items-center relative -translate-x-[25%] max-desktop:translate-x-0 ">
          ...
          >
            <svg
              ...
              fill="none"
              viewBox="0 0 21 20"
              className="inline-block max-tablet:m-0 mr-2 relative -top-[2px]"
            >
              <path
            ...
            <span className="max-tablet:hidden">Links</span>
          </Link>
          <Link
            to="/profile"
            className={`px-4 text-mediumGrey p-3 font-bold rounded-lg ${
          ...
          >
            ...
            <span className="max-tablet:hidden">Profile Details</span>
          </Link>
        </nav>
        ...
        >
          <span className="max-tablet:hidden">Preview</span>
          <img
